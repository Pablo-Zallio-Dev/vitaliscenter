...
const CommentsSection = () => {
      return (
            <div className=" flex flex-col items-center pb-20 md:pb-28 px-5 md:px-12 bg-background ">
                  <div className=" w-full max-w-336  ">
                        <div className=" flex flex-col gap-8 md:flex-row md:justify-between md:items-center ">
                              ...
                              <Link className=' text-accent hover:text-text font-catamaran uppercase tracking-widest text-xs transition-colors duration-200 ' href={''}>Opiniones en google</Link>
                        </div>
                        <div className=" flex flex-wrap gap-12 xl:gap-32 py-10 justify-center">
                              <div className=" flex flex-col justify-between gap-3 max-w-90 ">
