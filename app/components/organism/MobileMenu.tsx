...
const MobileMenu = () => {
  ...
  return (
    <section className={` fixed inset-0 z-50 lg:hidden w-full h-dvh transition-all duration-300 ease-in-out ${isActiveMenu ? ' bg-background-dark/20 pointer-events-auto' : 'pointer-events-none'} `}>
