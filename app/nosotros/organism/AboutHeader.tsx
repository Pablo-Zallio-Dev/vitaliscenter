...
const AboutHeader = () => {
      return (
            <Container className=' pt-34 md:pt-20 bg-background'>
                  ...
                  <div className=" flex flex-col gap-10 md:flex-row md:justify-between mt-8 pb-12 ">
                        ...
                        <div className="w-full md:max-w-90 md:self-end ">
                              <TextElement variant={'text'} as={'p'} className=' pb-6 '>
                                    Stick Fenomenal nació en Torrent con la intención de hacer las cosas de otra manera: menos volumen de pacientes y más atención real.
                              </TextElement>
